...
from app.routers.video import setArtifact, createThumbnail, inference_each_frame
...
class TestVideoAPI:
    ...
    def test_update_artifact(self):
        ...
        setArtifact(test_artifact.id, {"status": "test_done"})
        assert (
    ...
    def test_inference_frame(self):
        ...
        thumbnail = inference_each_frame("test_vid")
